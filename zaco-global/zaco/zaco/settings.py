"""
Django settings for zaco project.
...
SECRET_KEY = 'django-insecure-rs^fenb!^7-pv=*o-tre9d1p)zqb)09qmu8(_okibl(mvlm7r@'
...
WSGI_APPLICATION = 'zaco.wsgi.application'
